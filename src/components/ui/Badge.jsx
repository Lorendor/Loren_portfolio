...
const Badge = () => {
  return (
    <div className="flex items-center justify-end gap-10 font-bold pt-2 pr-10 relative z-20">
      <div className="flex items-center text-black dark:bg-white/10 dark:text-white bg-white/15 backdrop-blur-md shadow-purple/30 border font-inter border-white/10 rounded-full px-5 py-2 gap-4 w-fit shadow-lg hover:bg-white/15 dark:hover:bg-white/10 hover:border-purple/20 dark:hover:border-purple/20 transition-all duration-300">
